  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown">
        ...
        @if(Auth::check())
          <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">{{"Bonjour ". Auth::user()->username. " !"}}<span class="caret"></span></a>
        ...
        @else
          <li>{{HTML::linkAction('UsersController@login', 'Connexion', array('class'=>'nav-link'))}}</li>
          <li>{{HTML::linkAction('UsersController@create', 'Inscription', array('class'=>'nav-link'))}}</li>
        @endif
      </li>
    </ul>
  </div><!-- /.navbar-collapse -->
